        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?php echo e(url('atendente/logout')); ?>" class="dropdown-toggle">
                                <?php echo e(auth()->guard('atendente')->user()->name); ?>  <i class="fa fa-btn fa-sign-out"></i>Logout</a> <span class="caret"></span>
                            </a>
                        </li>
                </ul>
            </div>
