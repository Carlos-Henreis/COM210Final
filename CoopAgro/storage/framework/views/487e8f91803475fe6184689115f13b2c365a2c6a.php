        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo e(url('/presidente')); ?>">Área Presidente</a></li>
                    <li><a href="<?php echo e(url('/atendente')); ?>">Área Atendente</a></li>
                    <li><a href="<?php echo e(url('/tecnico')); ?>">Área Tecnico</a></li>
                </ul>
            </div>
